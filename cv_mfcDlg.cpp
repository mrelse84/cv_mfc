...
CcvmfcDlg::CcvmfcDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_CV_MFC_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CcvmfcDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_PICTURE, m_picture);
}

BEGIN_MESSAGE_MAP(CcvmfcDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_WM_DESTROY()
...
void CcvmfcDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CcvmfcDlg::OnQueryDragIcon()
{
...
void CcvmfcDlg::OnTimer(UINT_PTR nIDEvent)
{
